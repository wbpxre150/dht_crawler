...
typedef struct {
    ...
    int global_bootstrap_target;       /* Default: 200. Nodes collected by supervisor bootstrap. */
    int global_bootstrap_timeout_sec;  /* Default: 600. Hard cap on supervisor bootstrap. */
